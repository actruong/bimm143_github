...
author: "Anthony Truong (PID: A16906178)"
format: pdf 
toc: true
---
...
ggplot(genes) + 
  ...
  geom_point() + 
  scale_color_manual(values = c("purple", "gray", "orange")) + theme_classic() + labs(x = "Condition 1", y = "Condition 2", title = "Gene Regulation for Condition 1 vs Condition 2")
```
